...
//Импорт файлов
bird.src = "fish2.png";//Импортируем изображение с птицой
bg.src = "water2.jpg";//Импортируем изображение заднего фона
...
function draw() { //Создаем функцию draw
	...
	for(let i = 0; i < pipe.length; i++) {//в этом цикле мы будем генерировать премятствия для птички
